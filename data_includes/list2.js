...
var items = [
    ...
    ["filler", "DashedSentence", {s:"The salesman needs updated information before the end of the quarter."},
    ...
    ["dtrain", "DashedSentence", {s:"The valiant hero needs recognized for his courageous actions."},
    ...
    ["dtrain", "DashedSentence", {s:"The research assistant needs rewarded for all their hard work."},
    ...
    ["filler", "DashedSentence", {s:"The nurse needs disinfected needles placed in their respective drawer."},
    ...
    ["dtrain", "DashedSentence", {s:"The workers need paid for completing construction."},
    ...
    ["filler", "DashedSentence", {s:"The school board needs pleased parents so that they can get more funding from the town."},
    ...
    ["dtrain", "DashedSentence", {s:"The customer needs served before everyone else in the restaurant."},
    ...
    ["filler", "DashedSentence", {s:"The high school student needs appointed study hours for the upcoming exam."},
    ...
    ["filler", "DashedSentence", {s:"The official needs translated documents for the court case."},
