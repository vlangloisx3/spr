...
var items = [
    ...
    ["critical", "DashedSentence", {s:"The fire needs to be stoked to keep it from burning out."},
    ...
    ["filler", "DashedSentence", {s:"The back lawn needs to be cut since the grass has grown too tall."},
    ...
    ["critical", "DashedSentence", {s:"The large pumpkin needs to be carved before it can be put on display."},
    ...
    ["critical", "DashedSentence", {s:"The lock needs to be checked so we can be sure the apartment is secure."},
    ...
    ["filler", "DashedSentence", {s:"The red wine needs to be refrigerated before it can be served."},
    ...
    ["critical", "DashedSentence", {s:"The computer program needs to be debugged before it can be handed in."},
     "Question", {hasCorrect: "A computer program", q:"What needs to be turned in?", as: ["A computer program", "An essay"]}],
    
    ["filler", "DashedSentence", {s:"The oak cabinet needs to be dusted before the house showing tomorrow."},
    ...
    ["critical", "DashedSentence", {s:"The television needs to be repaired before the series premiere airs."},
    ...
    ["filler", "DashedSentence", {s:"The new screws need to be tightened to keep the bookshelf from wobbling."},
    ...
    ["critical", "DashedSentence", {s:"The shirt needs to be ironed so the actor can wear it tonight."},
    ...
    ["filler", "DashedSentence", {s:"The noodles need to be heated for two minutes in the microwave."},
     "Question", {hasCorrect: "Two minutes", q:"How many minutes until the noodles are ready?", as: ["Two minutes", "Five minutes"]}],
    
    ["critical", "DashedSentence", {s:"The green light bulb needs to be changed since it just burned out."},
    ...
    ["critical", "DashedSentence", {s:"The blank CD needs to be burned so it can be given to the DJ."},
    ...
    ["filler", "DashedSentence", {s:"The car needs to be washed since it has not rained in weeks."},
    ...
    ["critical", "DashedSentence", {s:"The piano needs to be tuned so the musicians can play."},
    ...
    ["critical", "DashedSentence", {s:"The phone needs to be charged since its battery does not last long."},
    ...
    ["filler", "DashedSentence", {s:"The plastic bench needs to be folded before it can be put away."},
     "Question", {hasCorrect: "Plastic", q:"What material is the bench made out of?", as: ["Wood", "Plastic"]}],
    
    ["critical", "DashedSentence", {s:"The laundry needs to be rinsed before it can be put in the dryer."},
    ...
    ["critical", "DashedSentence", {s:"The term paper needs to be revised before the due date tomorrow."},
    ...
    ["critical", "DashedSentence", {s:"The room needs to be lighted so the students can read their books."},
    ...
    ["filler", "DashedSentence", {s:"The couch needs to be measured before it is loaded onto the truck."},
     "Question", {hasCorrect: "In a truck", q:"Where will the couch be loaded on?", as: ["On a truck", "On a boat"]}],
    
    ["critical", "DashedSentence", {s:"The patio needs to be renovated for the birthday party."},
    ...
    ["filler", "DashedSentence", {s:"The science book needs to be modified since the information is outdated."},
     "Question", {hasCorrect: "Yes", q:"Is the information out of date?", as: ["Yes", "No"]}],
    
    ["critical", "DashedSentence", {s:"The wood floor needs to be cleaned before the student's parents get here."},
    ...
    ["critical", "DashedSentence", {s:"The old chair needs to be fixed so the guests can sit on it."},
    ...
    ["filler", "DashedSentence", {s:"The school laptop needs to be connected to a power source."},
    ...
    ["critical", "DashedSentence", {s:"The white walls need to be painted to keep the tenants happy."},
    ...
    ["critical", "DashedSentence", {s:"The film needs to be copyrighted before it can be released."},
    ...
    ["filler", "DashedSentence", {s:"The sales report needs to be updated before it can be turned in to the manager."},
    ...
    ["critical", "DashedSentence", {s:"The oranges need to be peeled before they can be eaten."},
     "Question", {hasCorrect: "Oranges", q:"What will be eaten?", as: ["Oranges", "Apples"]}],
    
    ["filler", "DashedSentence", {s:"The beautiful picture needs to be trimmed so it can fit in the frame."},
    ...
    ["critical", "DashedSentence", {s:"The potatoes need to be boiled before they can be used in the soup."},
